...
rm -rf $FILE.anno.gene.exac $FILE.anno.gene.exac.clinseq $FILE.anno.gene.exac.clinseq.cadd $FILE.anno.gene.exac.clinseq.cadd.sift $FILE.anno.gene.exac.clinseq.cadd.sift.pph $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm.mcg $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm.mcg.pcg $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm.mcg.pcg.uvm $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm.mcg.pcg.uvm.germline $FILE.anno.gene.exac.clinseq.cadd.sift.pph.clinvar.hgmd.match.docm.mcg.pcg.uvm.germline.acmg 
